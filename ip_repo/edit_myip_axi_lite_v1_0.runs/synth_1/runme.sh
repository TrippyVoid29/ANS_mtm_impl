...
HD_PWD='c:/ans_mtm_impl/ip_repo/edit_myip_axi_lite_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_axi_lite_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_axi_lite_v1_0.tcl
