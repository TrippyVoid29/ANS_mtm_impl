...
HD_PWD='C:/ANS_mtm_impl/ANS_mtm_impl/ANS_mtm_impl.runs/ans_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ans_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ans_design_auto_pc_0.tcl
