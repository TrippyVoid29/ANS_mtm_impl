...
HD_PWD='C:/ANS_mtm_impl/ANS_mtm_impl/ANS_mtm_impl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ans_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ans_design_wrapper.tcl -notrace
