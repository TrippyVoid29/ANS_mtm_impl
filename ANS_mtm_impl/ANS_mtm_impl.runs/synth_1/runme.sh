...
HD_PWD='C:/ANS_mtm_impl/ANS_mtm_impl/ANS_mtm_impl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ans_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ans_design_wrapper.tcl
