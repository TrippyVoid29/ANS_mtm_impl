...
HD_PWD='C:/ANS_mtm_impl/ANS_mtm_impl/ANS_mtm_impl.runs/ans_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ans_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ans_design_rst_ps7_0_100M_0.tcl
